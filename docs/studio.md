# Using in TIBCO StreamBase&reg; Studio
...
The samples can also be imported into TIBCO StreamBase&reg; Studio :
...
By default, projects are organized in TIBCO StreamBase&reg; Studio in a flat structure :
